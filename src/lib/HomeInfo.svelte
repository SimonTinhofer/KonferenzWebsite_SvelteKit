...
<style>
	.info {
		background-image: url($lib/images/ConferenceBg.jpg);
	...
	.rightInfo {
		...
		font-weight: 400;
		text-shadow: var(--shadow) 0.1em 0.1em 1px;
		text-align: left;
